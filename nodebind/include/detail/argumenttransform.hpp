...
namespace nodebind
{
	namespace detail
	{
		...
		struct ReturnTransformation
		{
			...
			typedef typename boost::mpl::copy_if<ArgumentPolicies, HasOutPolicy>::type OutParameters;
			typedef typename boost::mpl::transform<OutParameters, TakeArgument>::type OutArguments;
		...
		{
			//This is a mpl::vector of the return values.
